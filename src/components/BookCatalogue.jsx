 ...
 * Inset borders: 18px #fff, 19px #14b8ad, 20px #fff, 21px #14b8ad
 * Bg:            #000 behind book
...
/* Exact inset box-shadow from style-nickel.css:
   inset 0 0 0 18px #fff, inset 0 0 0 19px #14b8ad,
   inset 0 0 0 20px #fff, inset 0 0 0 21px #14b8ad */
const PAGE_INSET = "inset 0 0 0 18px #fff, inset 0 0 0 19px #14b8ad, inset 0 0 0 20px #fff, inset 0 0 0 21px #14b8ad";
const MODAL_INSET = `inset 0 0 0 18px #fff, inset 0 0 0 19px #14b8ad, inset 0 0 0 20px #fff, inset 0 0 0 21px #14b8ad, rgba(0,0,0,0.4) 0 4px 20px`;
