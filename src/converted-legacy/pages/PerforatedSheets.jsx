            ...
            <aside className="grid_3 aside-left triggerAnimation animated" data-animate="fadeInLeft">
              <ul className="aside_widgets">
                <li className="widget widget_productlist">
                  ...
                  <ul>
                    <li><Link to="/perforated-sheets-manufacturer-supplier-exporter-in-mumbai-india">Mild Steel Perforated Sheets</Link></li>
                    <li><Link to="/perforated-sheets-manufacturer-supplier-exporter-in-mumbai-india">Stainless Steel Perforated Sheets</Link></li>
                    <li><Link to="/perforated-sheets-manufacturer-supplier-exporter-in-mumbai-india">Aluminium Perforated Sheets</Link></li>
                  </ul>
                </li>
              </ul>
              <ul className="aside_widgets">
