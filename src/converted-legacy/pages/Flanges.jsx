  ...
  return (
    <>
      ...
      <WebPageLd url={absoluteUrl('/flanges-stockist-supplier-exporter-in-mumbai-india')} title="Industrial Flanges Supplier in India" description="Manufacturer and stockist of stainless, duplex and alloy steel flanges — ANSI, DIN, ASME B16.5 standards. Export quality from Siyak Steel International, Mumbai." />
            ...
            <section id="page-title-flanges" className="page-title-1 " data-stellar-background-ratio="0.3">
                        ...
                        <div className="grid_8">
                            <div className="breadcrumbs triggerAnimation animated" data-animate="fadeInUp">
                                <ul>
                                    ...
                                    <li>
                                        <span className="active">Flanges</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<article className="grid_4 triggerAnimation animated" data-animate="fadeInLeft">
                            <section id="post-slider" className="nivoSlider">
                                <img src="img/products/flanges.jpg" alt="Stainless Steel Pipe Flanges Supplier" />
...
<div className="heading-bordered2"><h2><i className="icon icon-double-angle-right"></i><b> Types of Flanges</b></h2></div>

<p>PN ,Plate Blank Flanges, Screwed Bars ,Spectacle Blind, Lapped, Reducing , Welded Socketweld ,SORF ,Threaded, Weldneck, Slipon, Blind, Socket Weld, Lap Joint. Ring Joint. Oriface, Long Weldneck, Deck Flange, RTJ Flange</p><br />


<div className="devider1"></div>
<div className="heading-bordered2"><h2><i className="icon icon-double-angle-right"></i><b> Material Grade</b></h2></div>
<p>Nickel &amp; Copper Alloy, Stainless &amp; Duplex Steel, Carbon, Alloy Steel, Carbon Steel/ Law Temperature, AlloySteel</p><br />
...
<div className="devider1"></div>
<div className="heading-bordered2">
<h2><i className="icon icon-double-angle-right"></i><b> Stainless Steel Pipe Flanges</b></h2></div>
<p>ASTM A182  F304 / 304U / 304H / 310 / 316 / 316L / 317 / 317L / 321 / 347 / 904L etc.</p><br />

<div className="devider1"></div>
<div className="heading-bordered2">
<h2><i className="icon icon-double-angle-right"></i> <b>Carbon Steel Flanges</b></h2></div>
<p>ASTM A105 / A694 F42 / 46 / 52 / 56 / 60 / 65 / 70 / A350 LF3 / A350 LF2, etc.</p><br />
<br />
<div className="devider1"></div>
<div className="heading-bordered2">
<h2><i className="icon icon-double-angle-right"></i> <b>Alloy Steel Pipe Flange</b></h2></div>

<p>ASTM A182 F1/F5/F9/F11/F22/F91 etc.</p>
