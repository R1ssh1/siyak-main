  ...
  return (
    <>
      ...
      <WebPageLd url={absoluteUrl('/ferrule-fittings-stockist-supplier-exporter-in-mumbai-india')} description="OD tube ferrule fittings in stainless steel. Export quality compression fittings from Siyak Steel International, Mumbai." />
            ...
            <section id="page-title-ferrule-fittings" className="page-title-1 " data-stellar-background-ratio="0.3">
                        ...
                        <div className="grid_8">
                            <div className="breadcrumbs triggerAnimation animated" data-animate="fadeInUp">
                                <ul>
                                    ...
                                    <li>
                                        <span className="active">Ferrule Fittings</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <li><Link to="/valves-stockist-supplier-exporter-in-mumbai-india">Valves</Link></li>
                        ...
                        <article className="grid_9 triggerAnimation animated" data-animate="fadeInRight">
                            ...
                            <section className="heading-bordered">
                                <h1>Ferrule Fittings / Instrumentation Fittings</h1>
                            </section>
                            <p className="bold-content">Stainless Steel Ferrule Fittings Manufacturer, Carbon Steel Ferrule Fittings Supplier, Alloy Steel Instrumentation Fittings Exporter in India</p>
<div className="row">
...
<article className="grid_4 triggerAnimation animated" data-animate="fadeInLeft">
                            <section id="post-slider" className="nivoSlider">
                                <img src="img/products/ferrule-fittings1.jpg" alt="Stainless Steel Ferrule Fittings Supplier" />
                                <img src="img/products/ferrule-dairy-fittings1.jpg" alt="Alloy Steel Ferrule Fittings Exporter" />
                                <img src="img/products/ferrule-dairy-fittings2.jpg" alt="Instrumentation Fittings Exporter" />
...
<p>
We are engaged in importing and supplying a wide range of Ferrule Fittings that is available in different grades and specifications. These are sourced from authentic vendors, who make usa latest technology and quality raw material in the production process of forged pipefittings to make these in accordance with industry standards. Featuring dimensional accuracy, high tensile strength, and corrosion resistance, these pipe fittings can be easily fitted in the pipe. These fittings are extensively used in diverse industries such as Oil &amp; Gas, Cement, Fertilizers and Petrochemicals. We are known for our Ferrule Fittings etc.</p>



<div className="devider1"></div><br />
<div className="heading-bordered2"><h2><i className="icon icon-double-angle-right"></i><b> Material Grades</b></h2></div>

<p>Stainless Steel, Nickel Alloys, Carbon Steel, Alloy Steel, Monel, Nickel, lnconel, Hastelloy, Copper, Brass, Bronze, Titanium, Tantalum, Bimuth, Aluminium, High Speed Steel, Zinc, Lead, Etc.</p>

<div className="devider1"></div><br />
<div className="heading-bordered2"><h2><i className="icon icon-double-angle-right"></i><b> Types</b></h2></div>

<p>Nipples, Adaptors, Crosses, Union Ball Joints, Reducing Bushing, Reducers, Pipe  Caps, Couplings, Pipe Plug, Hollow Hex Plug, Elbow, Reducing  Union, 90 Deg. Union Elbow, Reducing 90 Deg. Union Elbow  Etc. Extender Leg 90 Deg. Union  Elbow, 45 Deg. Union Elbow, Union Tee, Female Connector, Male Connector, Manifold Tee, Locator Union, Extended Run Leg Union Tee, Reducing Tee, Tribow, ATW  Weld Ring, Tube Socket weld To Pipe Butt Weld, Tube Butt Weld To Tube  Socket Weld, Port Connector Etc. Also as perthe National &amp;  International Standard.</p>


<div className="devider1"></div><br />
<p className="bold-content">Double / Twin Ferrule Fittings Manufacturer, SS Ferrule Fittings Exporter, Comperssion Tube Fittings, Innstrumentation Tube Fittings Supplier in India.</p>
<div className="heading-bordered2"><h2><i className="icon icon-double-angle-right"></i><b> Items</b></h2></div>

<p>Threaded Bevel Seat 90° Elbow 90° Reducing Elbow, Non Tapered so• Elbow, Plain Bevel Seat 90° Elbow Short Outlet Tea 45<br />
</p><ul>
<li>Elbow</li>
<li>Equal Tee</li>
<li>Reducing Tee</li>
<li>Instrument Tee</li>
<li>Short Oudet Reducing Tee Equal Cross</li>
<li>Long Weld Ferrule</li>
<li>Short Weld Ferrule</li>
<li>Ferrule for Expanding (Racesslass)</li>
</ul>
<p></p><br />
