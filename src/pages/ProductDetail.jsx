          ...
          <div>
            ...
            <Reveal>
              ...
              <div className="mt-5 space-y-3">
                {category.short.split("\n\n").map((para, i) => (
                  <p key={i} className="text-[15px] leading-relaxed text-deep">{para}</p>
                ))}
              </div>
            </Reveal>
                ...
                <div>
                  ...
                  {groupPanels.length > 0 && (
                    <ul className="mt-5 space-y-2">
                      {groupPanels.map((gp) => (
                        <li key={gp.h2} className="flex items-start gap-2.5 text-[14.5px] text-deep">
            ...
            {category.items?.length > 0 && (
              <Reveal className="mt-10">
                <div>
                  ...
                  <div className="mt-2 h-[3px] w-20 bg-teal" />
                  <p className="mt-4 text-[14.5px] leading-relaxed text-deep">
                    {category.items.join(", ")}
                  </p>
                </div>
              </Reveal>
            ...
            {/* ---- 2c. SPEC ROWS TABLE — e.g. Clad Layer / Base Material for Cladded Plates */}
            {category.specRows?.length > 0 && (
              <Reveal className="mt-10">
                <div className="border border-steel overflow-hidden">
                  <table className="w-full text-left border-collapse text-[13.5px]">
                    <tbody>
                      {category.specRows.map((row, i) => (
                        <tr key={row.label} className={i !== category.specRows.length - 1 ? "border-b border-steel" : ""}>
                          <td className="px-5 py-3.5 font-bold text-deep whitespace-nowrap w-[160px] align-top border-r border-steel bg-white">
                            {row.label}
                          </td>
                          <td className="px-5 py-3.5 text-deep leading-relaxed bg-white">
                            {row.value}
                          </td>
                        </tr>
                      ))}
                ...
                <Reveal key={gp.h2} delay={gi * 0.05}>
                  ...
                  {gp.intro && (
                    <div className="mb-10">
                      ...
                      <div className="mt-2 h-[3px] w-20 bg-teal" />
                      <p className="mt-5 text-[15px] leading-relaxed text-deep">
                        {gp.intro}
                      </p>
                    </div>
                  )}
                  ...
                  {gp.sections.map((s) => (
                    <div key={s.h3} className="mb-10">
                      ...
                      <p className="mt-4 text-[13.5px] leading-relaxed text-deep tracking-wide whitespace-pre-wrap">
                        {gradeBlurb(s.body) ||
            ...
            <Reveal className="mt-14">
              <div className="border-t border-gray-200 pt-10">
                ...
                <p className="mt-4 text-[14px] leading-[1.85] text-deep">
                  {EXPORT_COUNTRIES}
                </p>
                <p className="mt-5 text-[14px] leading-[1.85] text-deep">
