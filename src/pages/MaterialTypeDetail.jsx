        ...
        <div className="max-w-7xl px-6 grid lg:grid-cols-[260px_1fr] gap-10">
          ...
          <div>
            ...
            <Reveal>
              ...
              <p className="mt-5 text-[15.5px] leading-relaxed text-deep">
                ...
                <div>
                  ...
                  <div className="mt-7 space-y-8">
                    <div className="border-l-[3px] border-teal/50 pl-5 ml-0.5">
                      ...
                      <p className="mt-3 text-[14px] leading-relaxed text-deep tracking-wide whitespace-pre-wrap">
                        {gradeBlurb(active)}
                      </p>
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="mt-4 text-sm sm:text-[15px] text-deep leading-relaxed">{v.desc}</p>
