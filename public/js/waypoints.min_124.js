...
<link rel="stylesheet" href="../css/main.min_870.css">




<!-- Revolution slider -->
<link rel="stylesheet" href="../css/settings.min_870.css">
...
<link href="../css/translateelement_870.css" rel="stylesheet">
...
<!--[if lt IE 9]>
        ...
        <![endif]-->
<link rel="stylesheet" href="../css/animate_870.css">
...
a.float:hover{
  ...
  <section id="top-bar-wrapper">
    <div id="top-bar" class="clearfix">
      <div class="mscroll mobile-hide"> <span class="blink_me"><img src="../images/govt_870.png" class="img-responsive" alt="Neon Alloys :: GOVERNMENT RECOGNISED STAR EXPORT HOUSE"> "GOVERNMENT RECOGNISED STAR EXPORT HOUSE"</span> </div>
...
function googleTranslateElementInit() {
  ...
  <header id="header" class="clearfix">
    <section id="logo"> <a href="index.php"> <img src="../images/logo_870.png" title="Neon Alloys" alt="Neon Alloys"> </a> </section>
                            ...
                            <li class="blog-post format-standard">
                                ...
                                <div class="post-media-container">
                                    <a href="https://www.neonalloys.com/">
                                        <img src="../cms_869.html" style="width:80% !important;" alt="">
                                    </a>
                                ...
                                <article class="post-body">
                                    ...
                                    <article class="post-author">
                                        ...
                                        <div class="img-container">
                                            <img src="../images/user_869.jpg" alt="post author">
                                        </div>
...
<li><a href="https://www.linkedin.com/company/neon-alloys" target="blank" class="pixons-linkedin"></a></li>
          ...
          <ul class="grid_3 footer-widget-container">
            ...
            <li class=" widget qrcode ">
              <p><img src="../images/static_qr_code_without_logo_870.jpg"></p>
            </li>
          </ul>
          <!-- .widget.widget_text start --> 
...
<div class="popup-wrapper" id="popup">
	<div class="popup-container">
        ...
        <!-- scripts -->
        <script src="jquery-1.9.1_870.js"></script> <!-- jQuery library -->  
        <script src="jquery-migrate-1.2.1.min_870.js"></script> <!-- jQuery migrate -->
        <script src="jquery.placeholder.min_870.js"></script><!-- jQuery placeholder fix for old browsers -->
        <script src="modernizr.custom_870.js"></script> <!-- jQuery modernizr -->
        <script src="jquery.dlmenu_870.js"></script><!-- responsive navigation -->
        <script type="text/javascript"> 
$(function() {
        $('#dl-menu').dlmenu({
            animationClasses: {
        ...
        <script src="waypoints.min_870.js"></script><!-- js for animating content -->
        <script src="retina-1.1.0.min_870.js"></script><!-- retina ready script -->
        <script src="jquery.themepunch.plugins.min_870.js"></script><!-- revolution slider -->
        <script src="jquery.themepunch.revolution.min_870.js"></script><!-- revolution slider -->
        <script src="jquery.stellar.min_870.js"></script><!-- parallax scrolling -->
        
        
       
        <script src="jquery.prettyPhoto_870.js"></script> <!-- prettyPhoto lightbox -->
        <script src="jquery.nivo.slider_870.js"></script><!-- nivo slider -->
		<script src="nicescroll.min_870.js"></script> <!-- Nice scroll Plugin -->
        <script src="include_870.js"></script> <!-- jQuery custom options -->
