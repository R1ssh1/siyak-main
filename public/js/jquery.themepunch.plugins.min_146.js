...
<link rel="stylesheet" href="../css/main.min_1025.css">




<!-- Revolution slider -->
<link rel="stylesheet" href="../css/settings.min_1025.css">
...
<link href="../css/translateelement_1025.css" rel="stylesheet">
...
<!--[if lt IE 9]>
        ...
        <![endif]-->
<link rel="stylesheet" href="../css/animate_1025.css">
...
a.float:hover{
    ...
    line-height:60px;
        ...
        <style type="text/css">
			.neon-post ul {margin-left:30px;}
			.neon-post li {list-style:square; line-height:20px; margin-left:10px; padding:3px;}
		</style>
    </head>
  ...
  <section id="top-bar-wrapper">
    <div id="top-bar" class="clearfix">
      <div class="mscroll mobile-hide"> <span class="blink_me"><img src="../images/govt_1025.png" class="img-responsive" alt="Neon Alloys :: GOVERNMENT RECOGNISED STAR EXPORT HOUSE"> "GOVERNMENT RECOGNISED STAR EXPORT HOUSE"</span> </div>
...
function googleTranslateElementInit() {
...
</script><script type="text/javascript" src="element.js"></script>
  ...
  <header id="header" class="clearfix">
    <section id="logo"> <a href="index.php"> <img src="../images/logo_1025.png" title="Neon Alloys" alt="Neon Alloys"> </a> </section>
                        ...
                        <div class="grid_8">
                            <div class="breadcrumbs triggerAnimation animated" data-animate="fadeInUp">
                                <ul>
                                    ...
                                    <li><a href="http://www.neonalloys.com/blog.php">Blog / </a></li>
...
<!-- Widget End ::Products List --> 
                                
                        </aside><!-- .grid_3.aside-left end -->

                        <!-- .grid_9 start -->
                        <ul class="grid_9 blog-posts triggerAnimation animated fadeInLeft" data-animate="fadeInLeft">
                            ...
                            <li class="blog-post format-standard">
                                ...
                                <div class="post-media-container">
                                    <a href="https://www.neonalloys.com/">
                                        <img src="../cms_1024.html" style="width:80% !important;" alt="">
                                    </a>

                                    <div class="post-media-hover">
                                        <a href="https://www.neonalloys.com/" class="mask"></a>
                                    </div>
                                ...
                                <article class="post-body">
                                    ...
                                    <article class="post-author">
                                        ...
                                        <div class="img-container">
                                            <img src="../images/user_1024.jpg" alt="post author">
                                        </div>

                                        <div class="info">
                                            <a href="#">
                                                <h6>Team Neon Alloys</h6>
                                            </a>
                                            <span class="member">Government Recognise Star Export House</span>

                                            <p>Leading Manufacturer &amp; exporters of all kind of industrial steels products. We Export Pipes &amp; Tubes, Buttweld Fittings, Flanges, Sheets, Plates &amp; Coils, Fasteners, Angles &amp; Channels, Tube Sheets, Round Bars, Socketweld Fitings &amp; Others etc.</p>
                                        </div>
...
<li><a href="https://www.linkedin.com/company/neon-alloys" target="blank" class="pixons-linkedin"></a></li>
          ...
          <ul class="grid_3 footer-widget-container">
            ...
            <li class=" widget qrcode ">
              <p><img src="../images/static_qr_code_without_logo_1025.jpg"></p>
            </li>
          </ul>
          <!-- .widget.widget_text start --> 
...
<div class="popup-wrapper" id="popup">
	<div class="popup-container">
        ...
        <!-- scripts -->
        <script src="jquery-1.9.1_1025.js"></script> <!-- jQuery library -->  
        <script src="jquery-migrate-1.2.1.min_1025.js"></script> <!-- jQuery migrate -->
        <script src="jquery.placeholder.min_1025.js"></script><!-- jQuery placeholder fix for old browsers -->
        <script src="modernizr.custom_1025.js"></script> <!-- jQuery modernizr -->
        <script src="jquery.dlmenu_1025.js"></script><!-- responsive navigation -->
        <script type="text/javascript"> 
$(function() {
        $('#dl-menu').dlmenu({
            animationClasses: {
        ...
        <script src="waypoints.min_1025.js"></script><!-- js for animating content -->
        <script src="retina-1.1.0.min_1025.js"></script><!-- retina ready script -->
        <script src="jquery.themepunch.plugins.min_1025.js"></script><!-- revolution slider -->
        <script src="jquery.themepunch.revolution.min_1025.js"></script><!-- revolution slider -->
        <script src="jquery.stellar.min_1025.js"></script><!-- parallax scrolling -->
        
        
       
        <script src="jquery.prettyPhoto_1025.js"></script> <!-- prettyPhoto lightbox -->
        <script src="jquery.nivo.slider_1025.js"></script><!-- nivo slider -->
		<script src="nicescroll.min_1025.js"></script> <!-- Nice scroll Plugin -->
        <script src="include_1025.js"></script> <!-- jQuery custom options -->
