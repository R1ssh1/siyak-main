...
<link rel="stylesheet" href="../css/main.min_170.css">




<!-- Revolution slider -->
<link rel="stylesheet" href="../css/settings.min_170.css">
...
<link href="../css/translateelement_170.css" rel="stylesheet">
...
<!--[if lt IE 9]>
        ...
        <![endif]-->
<link rel="stylesheet" href="../css/animate_170.css">
...
a.float:hover{
  ...
  <section id="top-bar-wrapper">
    <div id="top-bar" class="clearfix">
      <div class="mscroll mobile-hide"> <span class="blink_me"><img src="../images/govt_170.png" class="img-responsive" alt="Neon Alloys :: GOVERNMENT RECOGNISED STAR EXPORT HOUSE"> "GOVERNMENT RECOGNISED STAR EXPORT HOUSE"</span> </div>
...
function googleTranslateElementInit() {
  ...
  <header id="header" class="clearfix">
    <section id="logo"> <a href="index.php"> <img src="../images/logo_170.png" title="Neon Alloys" alt="Neon Alloys"> </a> </section>
                            ...
                            <li class="blog-post format-standard">
                                ...
                                <div class="post-media-container">
                                    <a href="https://www.neonalloys.com/">
                                        <img src="../cms_169.html" style="width:80% !important;" alt="">
                                    </a>
                                ...
                                <article class="post-body">
                                    ...
                                    <article class="post-author">
                                        ...
                                        <div class="img-container">
                                            <img src="../images/user_169.jpg" alt="post author">
                                        </div>
...
<li><a href="https://www.linkedin.com/company/neon-alloys" target="blank" class="pixons-linkedin"></a></li>
          ...
          <ul class="grid_3 footer-widget-container">
            ...
            <li class=" widget qrcode ">
              <p><img src="../images/static_qr_code_without_logo_170.jpg"></p>
            </li>
          </ul>
          <!-- .widget.widget_text start --> 
...
<div class="popup-wrapper" id="popup">
	<div class="popup-container">
        ...
        <!-- scripts -->
        <script src="jquery-1.9.1_170.js"></script> <!-- jQuery library -->  
        <script src="jquery-migrate-1.2.1.min_170.js"></script> <!-- jQuery migrate -->
        <script src="jquery.placeholder.min_170.js"></script><!-- jQuery placeholder fix for old browsers -->
        <script src="modernizr.custom_170.js"></script> <!-- jQuery modernizr -->
        <script src="jquery.dlmenu_170.js"></script><!-- responsive navigation -->
        <script type="text/javascript"> 
$(function() {
        $('#dl-menu').dlmenu({
            animationClasses: {
        ...
        <script src="waypoints.min_170.js"></script><!-- js for animating content -->
        <script src="retina-1.1.0.min_170.js"></script><!-- retina ready script -->
        <script src="jquery.themepunch.plugins.min_170.js"></script><!-- revolution slider -->
        <script src="jquery.themepunch.revolution.min_170.js"></script><!-- revolution slider -->
        <script src="jquery.stellar.min_170.js"></script><!-- parallax scrolling -->
        
        
       
        <script src="jquery.prettyPhoto_170.js"></script> <!-- prettyPhoto lightbox -->
        <script src="jquery.nivo.slider_170.js"></script><!-- nivo slider -->
		<script src="nicescroll.min_170.js"></script> <!-- Nice scroll Plugin -->
        <script src="include_170.js"></script> <!-- jQuery custom options -->
