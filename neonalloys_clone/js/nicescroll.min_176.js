...
<link rel="stylesheet" href="../css/main.min_1234.css">




<!-- Revolution slider -->
<link rel="stylesheet" href="../css/settings.min_1234.css">
...
<link href="../css/translateelement_1234.css" rel="stylesheet">
...
<!--[if lt IE 9]>
        ...
        <![endif]-->
<link rel="stylesheet" href="../css/animate_1234.css">
...
a.float:hover{
  ...
  <section id="top-bar-wrapper">
    <div id="top-bar" class="clearfix">
      <div class="mscroll mobile-hide"> <span class="blink_me"><img src="../images/govt_1234.png" class="img-responsive" alt="Neon Alloys :: GOVERNMENT RECOGNISED STAR EXPORT HOUSE"> "GOVERNMENT RECOGNISED STAR EXPORT HOUSE"</span> </div>
...
function googleTranslateElementInit() {
  ...
  <header id="header" class="clearfix">
    <section id="logo"> <a href="index.php"> <img src="../images/logo_1234.png" title="Neon Alloys" alt="Neon Alloys"> </a> </section>
                            ...
                            <li class="blog-post format-standard">
                                ...
                                <div class="post-media-container">
                                    <a href="https://www.neonalloys.com/">
                                        <img src="../cms_1233.html" style="width:80% !important;" alt="">
                                    </a>
                                ...
                                <article class="post-body">
                                    ...
                                    <article class="post-author">
                                        ...
                                        <div class="img-container">
                                            <img src="../images/user_1233.jpg" alt="post author">
                                        </div>
...
<li><a href="https://www.linkedin.com/company/neon-alloys" target="blank" class="pixons-linkedin"></a></li>
          ...
          <ul class="grid_3 footer-widget-container">
            ...
            <li class=" widget qrcode ">
              <p><img src="../images/static_qr_code_without_logo_1234.jpg"></p>
            </li>
          </ul>
          <!-- .widget.widget_text start --> 
...
<div class="popup-wrapper" id="popup">
	<div class="popup-container">
        ...
        <!-- scripts -->
        <script src="jquery-1.9.1_1234.js"></script> <!-- jQuery library -->  
        <script src="jquery-migrate-1.2.1.min_1234.js"></script> <!-- jQuery migrate -->
        <script src="jquery.placeholder.min_1234.js"></script><!-- jQuery placeholder fix for old browsers -->
        <script src="modernizr.custom_1234.js"></script> <!-- jQuery modernizr -->
        <script src="jquery.dlmenu_1234.js"></script><!-- responsive navigation -->
        <script type="text/javascript"> 
$(function() {
        $('#dl-menu').dlmenu({
            animationClasses: {
        ...
        <script src="waypoints.min_1234.js"></script><!-- js for animating content -->
        <script src="retina-1.1.0.min_1234.js"></script><!-- retina ready script -->
        <script src="jquery.themepunch.plugins.min_1234.js"></script><!-- revolution slider -->
        <script src="jquery.themepunch.revolution.min_1234.js"></script><!-- revolution slider -->
        <script src="jquery.stellar.min_1234.js"></script><!-- parallax scrolling -->
        
        
       
        <script src="jquery.prettyPhoto_1234.js"></script> <!-- prettyPhoto lightbox -->
        <script src="jquery.nivo.slider_1234.js"></script><!-- nivo slider -->
		<script src="nicescroll.min_1234.js"></script> <!-- Nice scroll Plugin -->
        <script src="include_1234.js"></script> <!-- jQuery custom options -->
